...
export function ConvocationFormPage() {
  ...
  const {
    state: { memberships, loading: membershipsLoading },
  } = useTeamScopeContext();
  ...
  useEffect(() => {
    ...
    const loadSchedules = async () => {
      ...
      const scheduleResult = await listTeamSchedules(manageableMemberships);
      ...
      Object.entries(scheduleResult.data).forEach(([teamId, team]) => {
        byId[teamId] = {
          id: team.id,
          name: team.name,
          seasonStart: team.seasonStart,
          holidayStart: team.holidayStart,
          gameDefinitions: parseGameDefinitions(team.gameDefinitions),
  ...
  const handleCreate = async () => {
    ...
    const createResult = await createConvocation({
